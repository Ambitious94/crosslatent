...
def main():
    ...
    parser.add_argument("--latent_cross_fusion", type=str, choices=["pure", "re_text_cache", "text_cache", "re_c2c"], default="pure",
                        help="Fusion mode for latent_cross_agent: pure, RE-only anchor cache, NER+RE anchor cache, or RE C2C cache transfer.")
